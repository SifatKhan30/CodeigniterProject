                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="banner" class="form-control" id="exampleInputEmail1" placeholder="Enter Title ">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="exampleInputPassword1">Territory</label>
                                                        <input type="text" name="territory" class="form-control" id="exampleInputEmail1" placeholder="Enter Title ">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleInputPassword1">Price</label>
                                                        <input type="text" name="amount" class="form-control" id="exampleInputEmail1" placeholder="Enter Title ">
                                                    </div>
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <table class="table table-bordered">
                                ...
                                <?php foreach ($hspan as $k => $v) { ?>
                                    <tr>
                                        <td><?php echo $k + 1 ?></td>
                                        <td><?php echo $v->banner ?></td>
                                        ...
                                        <td><img src="<?php echo base_url('uploads/' . $v->logo) ?>" width="100" height="80" /></td>
