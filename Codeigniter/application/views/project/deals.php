    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="border-button"><a href="<?php echo base_url('welcome/about') ?>">Discover More</a></div>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="col-lg-6 col-sm-6">
          <div class="item">
            <div class="row">
              <div class="col-lg-6">
                <div class="image">
                  <img src="<?php echo base_url('assets/') ?>assets/images/deals-01.jpg" alt="">
                </div>
              </div>
        ...
        <div class="col-lg-6 col-sm-6">
          <div class="item">
            <div class="row">
              <div class="col-lg-6">
                <div class="image">
                  <img src="<?php echo base_url('assets/') ?>assets/images/deals-02.jpg" alt="">
                </div>
              </div>
              <div class="col-lg-6 align-self-center">
                <div class="content">
        ...
        <div class="col-lg-6 col-sm-6">
          <div class="item">
            <div class="row">
              <div class="col-lg-6">
                <div class="image">
                  <img src="<?php echo base_url('assets/') ?>assets/images/deals-03.jpg" alt="">
                </div>
              </div>
              <div class="col-lg-6 align-self-center">
                <div class="content">
        ...
        <div class="col-lg-6 col-sm-6">
          <div class="item">
            <div class="row">
              <div class="col-lg-6">
                <div class="image">
                  <img src="<?php echo base_url('assets/') ?>assets/images/deals-04.jpg" alt="">
                </div>
              </div>
              <div class="col-lg-6 align-self-center">
                <div class="content">
