...
<html lang="en">
  ...
  <head>
    ...
    <?php $this->load->view('project/layout') ?>
...
<body>
  ...
  <header class="header-area header-sticky">
    <div class="container">
        <div class="row">
            <div class="col-12">
            <?php $this->load->view('project/menu') ?>
            </div>
        </div>
    </div>
  </header>
        ...
        <div class="col-lg-12">
          <div class="content">
            ...
            <div class="main-button">
              <a href="<?php echo base_url('Welcome/reservation')?>">Discover More</a>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              <div class="owl-cites-town owl-carousel">
                <div class="item">
                  <div class="thumb">
                    <img src="<?php echo base_url('assets/') ?>assets/images/cities-01.jpg" alt="">
                    <h4>Havana</h4>
                  </div>
                </div>
                <div class="item">
                  <div class="thumb">
                    <img src="<?php echo base_url('assets/') ?>assets/images/cities-02.jpg" alt="">
                    <h4>Kingston</h4>
                  </div>
                </div>
                <div class="item">
                  <div class="thumb">
                    <img src="<?php echo base_url('assets/') ?>assets/images/cities-03.jpg" alt="">
                    <h4>George Town</h4>
                  </div>
                </div>
                <div class="item">
                  <div class="thumb">
                    <img src="<?php echo base_url('assets/') ?>assets/images/cities-04.jpg" alt="">
                    <h4>Santo Domingo</h4>
                  </div>
                </div>
                <div class="item">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="owl-weekly-offers owl-carousel">
            <div class="item">
              <div class="thumb">
                <img src="<?php echo base_url('assets/') ?>assets/images/offers-01.jpg" alt="">
                <div class="text">
                  ...
                  <div class="main-button">
                    <a href="<?php echo base_url('Welcome/reservation')?>">Make a Reservation</a>
                  </div>
                </div>
              </div>
            </div>
            <div class="item">
              <div class="thumb">
                <img src="<?php echo base_url('assets/') ?>assets/images/offers-02.jpg" alt="">
                <div class="text">
            ...
            <div class="item">
              <div class="thumb">
                <img src="<?php echo base_url('assets/') ?>assets/images/offers-03.jpg" alt="">
                <div class="text">
      ...
      <div class="row">
        <div class="col-lg-6 align-self-center">
          <div class="left-image">
            <img src="<?php echo base_url('assets/') ?>assets/images/about-left-image.jpg" alt="">
          </div>
        </div>
        <div class="col-lg-6">
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="main-button text-center">
            <a href="<?php echo base_url('Welcome/deals')?>">Discover All Places</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          <div class="border-button">
            <a href="<?php echo base_url('Welcome/reservation')?>">Book Yours Now</a>
          </div>
        </div>
      </div>
    </div>
