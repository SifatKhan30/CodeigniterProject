    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="main-button"><a href="<?php echo base_url('Welcome/about')?>">Discover More</a></div>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <form id="reservation-form" name="gs" method="post" role="search" action="<?php echo base_url('welcome/saveReserve') ?>">
            <div class="row">
              <div class="col-lg-12">
