        ...
        <div class="row">
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <!-- ***** Menu Start ***** -->
                    <ul class="nav">
                        <li><a href="<?php echo base_url('Welcome/project')?>" class="active">Home</a></li>
                        <li><a href="<?php echo base_url('Welcome/about')?>">About</a></li>
                        <li><a href="<?php echo base_url('welcome/deals')?>">Deals</a></li>
                        <li><a href="<?php echo base_url('welcome/reservation')?>">Reservation</a></li>
                ...
                <div class="item">
                  <div class="row">
                    <div class="col-lg-4 col-sm-5">
                      <div class="image">
                        <img src="<?php echo base_url('assets/') ?>assets/images/country-01.jpg" alt="">
                      </div>
                    </div>
              ...
              <div class="col-lg-12">
                <div class="item">
                  <div class="row">
                    <div class="col-lg-4 col-sm-5">
                      <div class="image">
                        <img src="<?php echo base_url('assets/') ?>assets/images/country-02.jpg" alt="">
                      </div>
                    </div>
                    <div class="col-lg-8 col-sm-7">
                      <div class="right-content">
