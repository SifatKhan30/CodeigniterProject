...
$tst=$db->query('select * from testimonial order by id desc');
if(isset($_POST['name'])){
    $name=$_POST['name'];
    ...
    $query="INSERT INTO `testimonial` (`id`, `name`, `designation`, `comment`,photo) VALUES (NULL, '$name','$designation', '$comment','$file')";
    $db->query($query);
