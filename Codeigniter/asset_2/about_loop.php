...
$tst=$db->query('select * from about_lp order by id desc');
if(isset($_POST['title'])){
    $title=$_POST['title'];
    $subtitle=$_POST['subtitle'];
   
    $file=$_FILES['logo']['name'];
    move_uploaded_file($_FILES['logo']['tmp_name'],'./assets/logo/'.$file);
    $query="INSERT INTO `about_lp` (`id`, `title`, `subtitle`, `logo`) VALUES (NULL, '$title','$subtitle', '$file')";
    $db->query($query);
    header('Location:about_loop.php');
}
              ...
              <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="col-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="designation" class="form-control" id="exampleInputEmail1" placeholder="Enter Title " >
                    </div>
        ...
        <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                <table class="table table-bordered">
                    ...
                    <?php $i=0; while($data=$tst->fetch_assoc()){ ?>
                        <tr>
                            <td><?php echo ++$i ?></td>
